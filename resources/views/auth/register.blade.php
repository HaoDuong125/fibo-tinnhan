            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-12 col-md-6 my-5 py-5 px-4 sec-box-white">
                    <form id="formAction" method="POST" action="{{ route('register') }}">
                        @csrf
                        <h3 class="text-center text-uppercase">{{ __("layout.register") }}</h3>
                        @if(!empty($phone))
                        ...
                        {{-- <div class="company_el @if (old('type_account') == 1) d-none @endif">
                            <div class="form-outline my-3 ">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" style="padding-left: 1rem; padding-right: 1rem;">{{ empty($phone) ? __("login.continue") : __("layout.register") }}</button>
                        </div>
                        @else
